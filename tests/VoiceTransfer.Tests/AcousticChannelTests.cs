...
public sealed class AcousticChannelTests
{
    ...
    {
        var payload = Encoding.UTF8.GetBytes("acoustic round trip");
    ...
    {
        var payload = Encoding.UTF8.GetBytes("natural noise round trip");
        var microphoneSamples = CreateMicrophoneRecording(
    ...
    {
        var payload = Encoding.UTF8.GetBytes("limited speaker and microphone");
    ...
    public void RobustProfile_DecodesWithIndependentAudioClocks(int clockErrorPpm)
    {
        var payload = Encoding.UTF8.GetBytes(
            "Clock drift accumulates across this message.");
        var microphoneSamples = CreateMicrophoneRecording(
