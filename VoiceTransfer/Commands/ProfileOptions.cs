...
{
    [Option('p', "preset", Default = "normal", HelpText = "Speed preset: slow (150 baud), normal (300 baud), fast (350 baud), robust (50 baud, over-the-air). Sender & receiver must match.")]
    ...
    {
        return TransmissionProfile.FromOptions(Preset, BaudRate, PreambleBits,
