...
public sealed class SoundFlowBackend : IAudioBackend
{
    ...
    {
        return new SoundFlowPlayer(outputDeviceIndex);
    }

    public IAudioRecorder CreateRecorder(int inputDeviceIndex)
    {
        return new SoundFlowRecorder(inputDeviceIndex);
    }
    ...
    {
        return new SoundFlowDuplex(inputDeviceIndex, outputDeviceIndex);
    }

    internal static AudioFormat MakeFormat()
    {
