...
internal sealed class PortAudioPlayer(int deviceIndex) : IAudioPlayer
{
    public void Play(float[] samples)
    {
        ...
        StreamCallbackResult Callback(IntPtr nint, IntPtr output, uint frameCount, ref StreamCallbackTimeInfo streamCallbackTimeInfo, StreamCallbackFlags streamCallbackFlags, IntPtr nint1)
        {
